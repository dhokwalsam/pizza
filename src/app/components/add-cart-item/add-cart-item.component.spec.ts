...
describe('AddCartItemComponent', () => {
  ...
  it('Price should match with the item selected', () => {
    expect(component).to.not.be.null;
    fixture.debugElement.query(By.css('.pizza')).nativeElement.click();
    fixture.detectChanges();
    fixture.debugElement.queryAll(By.css('.pizza-option'))[2].nativeElement.click();
    fixture.detectChanges();
  ...
  it('pizza and quantity filled  - should enable Add button', () => {
    expect(component).to.not.be.null;
    fixture.debugElement.query(By.css('.pizza')).nativeElement.click();
    fixture.detectChanges();
    fixture.debugElement.queryAll(By.css('.pizza-option'))[2].nativeElement.click();
    fixture.detectChanges();
    pizzaElement.nativeElement.dispatchEvent(new Event('selectionChange'));
